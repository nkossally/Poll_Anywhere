...
const mapStateToProps = (state, ownProps) => {
  ...
  Object.values(state.entities.groups)
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    updatePoll: (poll, id, choices, group) =>
      dispatch(updatePoll(poll, id, choices, group)),
    closeModal: () => dispatch(closeModal()),
    openModal: (user_id, selectedPolls) =>
      dispatch(openModal(user_id, selectedPolls)),
