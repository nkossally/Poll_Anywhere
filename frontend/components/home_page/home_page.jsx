    ...
    if (!this.props.user) {
      signUpBox = (
        <ul className="sign-up-block">
          ...
          <li>
            <Link className="sign-up-now" to="/signup">
              Sign up now
            </Link>
          </li>
        </ul>
    ...
    return (
      <ul>
        ...
        <li className="home-page-three">
          ...
          <img
            src={window.collectResponses}
            className="home-page-thirds"
            id="middle"
          />
        ...
        <li className="home-page-three">
          <div className="home-page-thirds">
            Use multiple choice questions to identify gaps in understanding, or
            kick off group discussions with a colorful word cloud.
          </div>
          <div className="home-page-thirds" id="middle">
            {
          ...
          <div className="home-page-thirds">
            Responses appear in an animated graph or chart embedded in your
            presentation. Results update live for all to see.
          </div>
        </li>
        <li>
          <ul>
            ...
            <li className="corporate-clients-small">
              We also help over 300,000 educators facilitate tough discussions
